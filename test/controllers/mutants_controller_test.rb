...
class MutantsControllerTest < ActionController::TestCase
  ...
  test "should create mutant" do
    assert_difference('Mutant.count') do
      post :create, mutant: { mutant_name: @mutant.mutant_name, power: @mutant.power, real_name: @mutant.real_name }
    end
  ...
  test "should update mutant" do
    patch :update, id: @mutant, mutant: { mutant_name: @mutant.mutant_name, power: @mutant.power, real_name: @mutant.real_name }
    assert_redirected_to mutant_path(assigns(:mutant))
  end
